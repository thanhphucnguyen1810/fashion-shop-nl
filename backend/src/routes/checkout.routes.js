...
router.get('/sepay-qr/:id', protect, checkoutController.getSepayQrInfo) // Lấy ảnh QR
router.get('/sepay-status/:id', protect, checkoutController.checkPaymentStatus) // Check trạng thái

router.post('/sepay/ipn', logSecurity('PAYMENT_WEBHOOK'), checkoutController.sepayIpn) // Webhook
